...
namespace ejercicio3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ingrese la opcion de procesador que desea");
            procesador = int.Parse(Console.ReadLine());
            Console.WriteLine("Ingrese la opcion de ram que desea");
            ram = int.Parse(Console.ReadLine());
            Console.WriteLine("Ingrese 1 si desea extender el disco o 0 si no lo desea");
